...
namespace GameHub.UI.Views.GameDetailsView
{
	public class GameDetailsPage: Gtk.Grid
	{
		...
		private void set_visible_widgets(Game.Status s)
		{
			...
			if (action_install.visible) action_install.grab_focus();
